      ...
      {isAdmin && (
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
          ...
          <form onSubmit={handleAddManager} className="space-y-4 mb-8 pb-6 border-b border-slate-200">
            ...
            <button
              type="submit"
              className="flex items-center bg-rose-500 hover:bg-rose-600 text-white font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors disabled:opacity-50"
              disabled={isLoading}
            >
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                        ...
                        <div className="flex items-center space-x-2 mt-3 sm:mt-0 flex-shrink-0">
                            <button
                                ...
                                className="text-slate-500 hover:text-rose-600 text-sm font-semibold flex items-center p-2 hover:bg-rose-50 rounded-md transition-colors disabled:opacity-50"
                            ...
                            <button
                                ...
                                className="text-slate-500 hover:text-red-600 text-sm font-semibold flex items-center p-2 hover:bg-red-50 rounded-md transition-colors disabled:opacity-50"
      ...
      {isEditModalOpen && editingManager && (
        <div role="dialog" aria-modal="true" aria-labelledby="edit-manager-modal-title" className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
          <div className="bg-white p-6 rounded-xl shadow-xl w-full max-w-lg">
            ...
            {error && <div role="alert" className="mb-3 p-3 bg-red-50 text-red-700 border border-red-200 rounded-lg text-sm">{error}</div>}
            <form onSubmit={handleUpdateManager} className="space-y-4">
              ...
              <div className="flex justify-end space-x-3 pt-6 border-t border-slate-200">
                <button 
                  ...
                  className="bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors"
                  disabled={isLoading}
                >
                  Скасувати
                </button>
                <button 
                  type="submit"
                  className="bg-rose-500 hover:bg-rose-600 text-white font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors disabled:opacity-50"
                  disabled={isLoading}
                >
