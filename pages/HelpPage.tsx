        ...
        <HelpSection title="Замовлення" icon={OrdersIcon}>
            <p>Повнофункціональний інструмент для обробки замовлень від створення до відправки.</p>
             <ul className="list-disc list-inside space-y-2 pl-2">
                ...
                <li><strong>Генерація документів:</strong> Створюйте та друкуйте Рахунок-фактуру та Товарно-транспортну накладну (ТТН) в один клік.</li>
            </ul>
        </HelpSection>
        ...
        <HelpSection title="Замовлення" icon={OrdersIcon}>
            <p>Основний інструмент для вашої щоденної роботи. Тут ви керуєте замовленнями.</p>
             <ul className="list-disc list-inside space-y-2 pl-2">
                ...
                <li><strong>Документи:</strong> Ви можете генерувати та друкувати рахунки-фактури та ТТН для клієнтів.</li>
            </ul>
        </HelpSection>
